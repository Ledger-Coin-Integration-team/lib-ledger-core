...
export ARCH=$1
if [ "${ARCH}" == 'armv7' ]; then
	export TOOLCHAIN_NAME='ios-nocodesign-14-3-dep-10-0-armv7'
	export OSX_SYSROOT=iphoneos
elif [ "${ARCH}" == 'arm64' ]; then
	export TOOLCHAIN_NAME='ios-nocodesign-14-3-dep-10-0-arm64'
	export OSX_SYSROOT=iphoneos
elif [ "${ARCH}" == 'bitcode' ]; then
	#ios-nocodesign-11-2-dep-9-0-bitcode-cxx11
	export TOOLCHAIN_NAME='ios-nocodesign-14-3-dep-10-0-bitcode-cxx11'
	#export TOOLCHAIN_NAME='ios-nocodesign-11-2-dep-9-3-arm64-armv7'
else
	export TOOLCHAIN_NAME='ios-nocodesign-14-3-dep-10-0'
